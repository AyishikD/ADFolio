...
const Intro = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Ayishik&apos;s Portfolio</title>
      </Head>
      <section id='home'>
        <div
          ...
          >
            ...
            <div className='mt-5 md:mt-10 flex gap-3'>
              ...
              <Link
                ...
                href="https://www.linkedin.com/in/ayishik-das-35a67a1a5"
              >
                Hire me
              </Link>
              {/* Download CV Button */}
              <Link
                ...
                href='https://drive.google.com/file/d/1KY6Kxs1ffhS5-EY3FRA_o5YbpbKVk3ml/view?usp=sharing'
                target='_blank'
              >
                Download CV
              </Link>
