        ...
        <div className='pb-[30px] px-[20px] md:px-[100px] lg:px-[200px] md:flex gap-[50px]'>
          ...
          >
            ...
            <div className='mt-5 justify-evenly text-justify'>
              ...
              An aspiring Computer Science and Business System Engineer with the ability to solve problems and
think out of the box. I want to work in the field of Software Development and learn new things. I am
enthusiastic about exploring new technologies which has the potential to improve user experience.
              </p>
            </div>
          </div>
        </div>
